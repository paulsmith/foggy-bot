...
if __name__ == "__main__":
    ...
    if data:
        ...
        result = {
            "forecast_data": data,
            "weather_report": response.__str__()
        }
